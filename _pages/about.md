...
- ``ICML 2025 <span style="color:red">Spotlight</span> (Top 2.6%)`` [Foundation Model Insights and a Multi-model Approach for Superior Fine-grained One-shot Subset Selection], **Zhijing Wan**, Zhixiang Wang, Zheng Wang, Xin Xu, and Shin’ichi Satoh, **ICML** 2025
